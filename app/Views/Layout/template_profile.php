...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #835331;">
            ...
            <!-- Nav Item - Berita -->
            <li class="nav-item">
                <a class="nav-link" href="/beritaku">
            ...
            <!-- Nav Item - Extra -->
            <li class="nav-item">
                <a class="nav-link" href="/ekstraku">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                src="<?= base_url() ?>/img/user/<?= ($user['image'] !== NULL && $user['image'] !== '') ? $user['image'] : 'default.png' ?>">
                            </a>
